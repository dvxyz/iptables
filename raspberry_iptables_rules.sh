...
# Generali
iptables -A INPUT -s 194.147.195.250 -j ACCEPT
...
# smtp services
# iptables -A INPUT -p tcp --match multiport --dports 110,143,587,993,995,2525 -j ACCEPT
iptables -A INPUT -p tcp -s 209.85.0.0/16 --dport 25 -j ACCEPT
...
iptables -A LOGGING -m limit --limit 2/min -j LOG --log-prefix='[netfilter] ' --log-level 4
